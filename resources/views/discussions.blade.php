            ...
            @if(Auth::check())
                @if($discuss->count()>0)
                  @foreach($discuss as $discus)
                   ...
                   en s           <div class="card-body" style="padding-top: 0rem;">
                                <!-- <div class="deals_item_name">The Quick Brown Fox Jumped Over the Lazy Dogs</div> -->
                                <hr>
                                <p class="card-text">{{$discus->discussion}}.</p>
                                 <div class="pull-right"><a href="{{route('discussions.show',$discus->id)}}" class="card-link"><button class="btn btn-primary">Read More..</button></a></div>
